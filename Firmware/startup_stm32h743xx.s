...
.word  _ebss
/* Custom modified code for the initialization of .ramfunc section */
.word _sramfunc
.word _eramfunc
.word _lramfunc
...
/* Custom modified code for copying */
  ldr r0, =_sramfunc     /* destination  (RAM)   */
  ldr r1, =_eramfunc     /* destination  (RAM)   */
  ldr r2, =_lramfunc     /* source start (FLASH) */
  movs r3, #0
